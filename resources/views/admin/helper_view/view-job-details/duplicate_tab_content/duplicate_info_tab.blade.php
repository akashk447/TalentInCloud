<div class="mt-3 ms-3 me-3" id="duplicate_info" style="display:none">
    <div class="ms-3 me-3">
        <div class="table-responsive table-card mb-1">
            @if ($count_duplicate_candidate > 0)
                <table class="table align-middle" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        @foreach ($get_all_job_applicants as $source_candidate)
                            @if (in_array($source_candidate->applicant_status, get_duplicate_applicant_list()))
                                <tr>
                                    <th scope="row">
                                        <div class="form-check">
