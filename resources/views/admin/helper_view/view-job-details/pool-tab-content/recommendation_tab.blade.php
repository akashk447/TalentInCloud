<div class="tab-pane" id="reference_tab" role="tabpanel">
    <div class="ms-3 me-3">
        <div class="table-responsive table-card mb-1">
                ...
                <table class="table align-middle"
                    ...
                    <tbody class="list form-check-all">
                        @foreach ($get_sourced_candidates as $source_candidate)
                            @if ($source_candidate->screen_status == 'Recommendation')
                                <tr>
                                    <th scope="row">
                                        <div class="form-check">
                                            <input
                                    ...
                                    <td class="customer_name">
                                        <a href="{{ route('view_pool_candidate', ['jobcode'=>$job_details->job_code,'screenid'=>$source_candidate->screen_id,'innertab'=>'recommended','key'=>bin2hex(random_bytes(32))]) }}">
            ...
            <div class="noresult">
                <div class="text-center">
                    ...
                    <p class="text-muted mb-5"> We did not find any recommended candidate for this job.</p>
                </div>
            </div>
        @endif
        </div>
