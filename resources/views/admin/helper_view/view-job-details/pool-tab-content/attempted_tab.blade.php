<div class="tab-pane" id="attempted_tab" role="tabpanel">
    <div class="ms-3 me-3">
                ...
                <table class="table align-middle"
                    ...
                    <tbody class="list form-check-all">
                        @foreach ($get_sourced_candidates as $source_candidate)
                            @if ($source_candidate->screen_status == 'Not Reachable' || $source_candidate->screen_status == 'Call Wait' || $source_candidate->screen_status == 'Switch Off' || $source_candidate->screen_status == 'No Response' )
                                <tr>
                                    <th scope="row">
                                        <div class="form-check">
                                            <input
                                    ...
                                    <td class="customer_name">
                                        <a href="{{ route('view_pool_candidate', ['jobcode'=>$job_details->job_code,'screenid'=>$source_candidate->screen_id,'innertab'=>'attempted','key'=>bin2hex(random_bytes(32))]) }}">
                                    ...
                                    <td class="status"><span
                                        class="badge badge-soft-danger text-uppercase">{{$source_candidate->screen_status}}</span>
                                </td>
            ...
            <div class="noresult">
                <div class="text-center">
                    ...
                    <p class="text-muted mb-5"> We
                        did not find any
                        attempted candidate for this job.</p>
                </div>
            </div>
        @endif
        </div>
