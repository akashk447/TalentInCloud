<div class="tab-pane active" id="sourced_tab" role="tabpanel">
    <div class="ms-3 me-3">
        <div class="table-responsive table-card mb-1">
            @if ($count_sourced_candidate > 0)
                <table class="table align-middle" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        @foreach ($get_sourced_candidates as $source_candidate)
                            @if ($source_candidate->screen_status == 'Sourced')
                                <tr>
                                    <th scope="row">
                                        <div class="form-check">
                                    ...
                                    <td class="customer_name">
                                        <a href="{{ route('view_pool_candidate', ['jobcode'=>$job_details->job_code,'screenid'=>$source_candidate->screen_id,'innertab'=>'sourced','key'=>bin2hex(random_bytes(32))]) }}">
                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" data-bs-placement="top"
                                                title="Remove {{ $source_candidate->candidate_name }}">
