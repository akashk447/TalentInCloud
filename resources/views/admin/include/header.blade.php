                            ...
                            <a href="{{ route('admin_dashboard') }}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('assets/images/logo-dark.png') }}"
                                        style="width: 185px;height:55px" alt="">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/images/logo-dark.png') }}"
                                        style="width: 185px;height:55px" alt="">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                                ...
                                <img id="" src="{{ asset('assets/images/india-flag-png-xl.jpg') }}"
                                    alt="Header Language" height="20" class="rounded" data-toggle="tooltip"
                        ...
                        <div class="ms-1 header-item d-none d-sm-flex">
                            <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                                data-toggle="fullscreen" id="full_screen">
                        ...
                        <div class="ms-1 header-item d-none d-sm-flex">
                            ...
                            <button type="button" id="log-off"
                                class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle ">
                                <i class='bx bx-power-off fs-22'></i>
                                {{-- </a> --}}
                            </button>
                        </div>
                        <div class="dropdown topbar-head-dropdown ms-1 header-item">
                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ asset('assets/images/Akash.jpg') }}" alt="Header Avatar">
                                    <span class="text-start ms-xl-2">
                                        <span
                                            class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{current(explode(' ',Auth::user()->first_name))}}</span>
                                        <span
                                            class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Developer</span>
                                    </span>
                                </span>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <h6 class="dropdown-header">Welcome {{current(explode(' ',Auth::user()->first_name))}}!</h6>
                                ...
                                <a class="dropdown-item" href="setting.php"><span
                                        class="badge bg-soft-success text-success mt-1 float-end">New</span><i
                                        class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span
                                        class="align-middle">Settings</span></a>
                                <a class="dropdown-item" href="{{route('lock_screen')}}"><i
                                        class="mdi mdi-lock text-muted fs-16 align-middle me-1"></i> <span
                                        class="align-middle">Lock screen</span></a>
                                <a class="dropdown-item" href="{{ route('log_out') }}"><i
