...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ route('admin_dashboard') }}" class="logo logo-dark">
            ...
            <span class="logo-lg">
                <img src="{{ asset('assets/images/logo-dark.png') }}" style="width: 185px;height:55px" alt="">
            </span>
        </a>
        ...
        <a href="{{ route('admin_dashboard') }}" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="{{ asset('assets/images/logo-light.png') }}" style="width: 185px;height:55px" alt="">
            </span>
        </a>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                <li class="menu-title"><span>Menu</li>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#">
                            <i class="ri-home-4-line"></i> <span data-key="r-dashboard">Home</span>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#resumebuzz-clients" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ri-building-4-line"></i> <span data-key="r-clients">Company</span>
                    </a>
                    <div class="collapse menu-dropdown" id="resumebuzz-clients">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('organisation') }}" class="nav-link" data-key="r-clients"> Manage
                                    Company </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('location') }}" class="nav-link" data-key="r-clients"> Manage
                                    Locations </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('contacts') }}" class="nav-link" data-key="r-clients"> Manage Contacts
                                </a>
                            </li>
                            {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#resumebuzz-jobs" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                    ...
                    <div class="collapse menu-dropdown" id="resumebuzz-jobs">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('add_jobs') }}" class="nav-link" data-key="r-jobs"> Add a job </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('manage_jobs')}}" class="nav-link" data-key="r-jobs"> Manage Job </a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#resumebuzz-candidates" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#resumebuzz-interviewes" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#resumebuzz-management" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="sidebarDashboards">
