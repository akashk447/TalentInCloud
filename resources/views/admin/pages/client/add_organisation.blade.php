...
@section('main_content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ Route('add_organisation') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-9">
                                    ...
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="OrganisationName" class="form-label">Company
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="ForminputState" class="form-label">About Company <span class="text-danger">*</span></label>
                                                        <textarea class="ckeditor-classic" name="about_client" id="about_client"></textarea>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="ForminputState" class="form-label">Upload Logo</label>
                                                        ...
                                                        <div class="input-group flex-nowrap">
                                                            <span class="input-group-text"
                                                                id="validationTooltipUsernamePrepend"><i
                                                                    class="ri-facebook-line fs-15 text-primary" data-bs-toggle="tooltip" title="Facebook"></i></span>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group flex-nowrap">
                                                            <span class="input-group-text"
                                                                id="validationTooltipUsernamePrepend"><i
                                                                    class="ri-twitter-line fs-15 text-primary" data-bs-toggle="tooltip" title="Twitter"></i></span>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group flex-nowrap">
                                                            <span class="input-group-text"
                                                                id="validationTooltipUsernamePrepend"><i
                                                                    class="ri-linkedin-line fs-15 text-primary" data-bs-toggle="tooltip" title="Linkedin"></i></span>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group flex-nowrap">
                                                            <span class="input-group-text"
                                                                id="validationTooltipUsernamePrepend"><i
                                                                    class=" ri-instagram-line fs-15 text-primary" data-bs-toggle="tooltip" title="Instagram"></i></span>
                            ...
                            <div class="col-lg-3">
                                <div data-aos="zoom-out-right">
                                    <p class="text-muted fs-15 mb-1"><b>Manage Company</b></p>
                                    <p class="text-muted">
                                    ...
                                    <div class="card mb-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="code-view">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label for="OrganisationName" class="form-label">Start Date</label>
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text" id="basic-addon1"><i class="ri-calendar-2-line fs-15 text-primary"></i></span>
                                                            <input type="text" name="start" class="form-control flatpickr-input active" data-provider="flatpickr" placeholder="DD-MM-YY" data-date-format="d M, Y" aria-label="Phone Number" maxlength="10" aria-describedby="basic-addon1">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="OrganisationName" class="form-label">End Date</label>
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text" id="basic-addon1"><i class="ri-calendar-2-line fs-15 text-primary"></i></span>
                                                            <input type="text" name="end" class="form-control flatpickr-input active" data-provider="flatpickr" placeholder="DD-MM-YY" data-date-format="d M, Y" aria-label="Phone Number" maxlength="10" aria-describedby="basic-addon1">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                    <label for="OrganisationName" class="form-label">Upload Agreement</label>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div data-aos="zoom-in">
                                    <div class="card mb-2">
                                        <div class="card-header align-items-center d-flex">
                                            <h4 class="card-title mb-0 flex-grow-1">Company Settings <span class="text-danger">*</span>
                                            </h4>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="websiteUrl" class="form-label">Applicant
                                                            Expiry / CV Validity</label>
                                                        
                                                            <input type="text" placeholder="In Days" name="expiry" 
                                                                class="form-control form-control-icon" 
                                                                aria-describedby="validationTooltipUsernamePrepend">
                                            ...
                                            <div id="have_id_type" style="display:none">
                                                ...
                                                <!-- <div class="row mb-3">
                                                    <div class="col-lg-6">
                                                        <label for="websiteUrl" class="form-label">Do you need to add ADHAR ID
                                                            number while uploading candidate?</label>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="form-check form-radio-primary mb-3">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="adhar" value="Yes" id="formradioRight5">
                                                                    <label class="form-check-label" for="formradioRight5">
                                                                        Yes
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 ">
                                                                <div class="form-check form-radio-primary mb-3">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="adhar" value="No" id="formradioRight5">
                                                                    <label class="form-check-label" for="formradioRight5">
                                                                        No
                                                                    </label>
                                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-6">
                                                        <label for="websiteUrl" class="form-label">Do you need to add PASSPORT
                                                            number while uploading candidate?</label>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="form-check form-radio-primary mb-3">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="passport" value="Yes" id="formradioRight5">
                                                                    <label class="form-check-label" for="formradioRight5">
                                                                        Yes
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 ">
                                                                <div class="form-check form-radio-primary mb-3">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="passport" value="No" id="formradioRight5">
                                                                    <label class="form-check-label" for="formradioRight5">
                                                                        No
                                                                    </label>
                                                                </div>
                                            ...
                                            <div id="ticket_number_type" style="display:none">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-lg-6">
                                                        <label for="websiteUrl" class="form-label">What is the Talent Portal
                                                            Link?</label>
                                                    </div>
                                                    <div class="col-lg-6">
