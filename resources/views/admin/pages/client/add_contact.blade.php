...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">ADD CONTACTS</h4>
        ...
        <div class="row">
            <div class="col-lg-12">
                <form name="contract_form" action="{{ Route('add_contacts') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="card mb-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input type="text" name="first_name" class="form-control form-control-icon" placeholder="First Name" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        <span class="input-group-text" id="addon-wrapping"><i class="ri-user-3-line fs-15 text-primary"></i></span>
                                                        <input type="text" name="last_name" class="form-control form-control-icon" placeholder="Last Name" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input type="text" name="designation" class="form-control form-control-icon" placeholder="Designation" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="ForminputState" name="address_id" class="form-select" data-choices data-choices-sorting="true">
                                                        ...
                                                        <option value="1">address2</option>
                                                        <option value="1">address3</option>
                                                        <option value="1">address4</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input type="text" name="facebook" class="form-control form-control-icon" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" placeholder="e.g. www.facebook.id">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input type="text" name="twitter" class="form-control form-control-icon" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" placeholder="e.g. www.twitter.id">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input type="text" name="linkedin" class="form-control form-control-icon" id="iconrightInput" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" placeholder="e.g. www.linkedin.id">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input type="text" name="instagram" class="form-control form-control-icon" id="iconrightInput" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" placeholder="e.g. www.instagram.id">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
