...
<head>
    ...
    <meta charset="utf-8" />
    <title>Lock Screen | Talent In Cloud</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Applicant Tracking System" name="description" />
    <meta content="Quacklabs Technologies" name="author" />
    ...
    <style>
        ...
        *,
        ...
        body {
            ...
            background-image: url('{{ asset('assets/images/lock-screen.jpg') }}');
...
<body>
    ...
    <div id="password" class=" auth-page-wrapper pt-5"
        style="background-image: url('{{ asset('assets/images/lock-screen.jpg') }}');background-attachment: fixed;
    background-position: center;
    background-repeat: no-repeat;
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="user-thumb text-center">
                                    ...
                                    <h5 class="font-size-15 mt-3">{{ Auth::user()->first_name }}</h5>
                                </div>
                                <div class="p-2 mt-4">
                                    <form action="{{ route('lock_screen_open_request') }}" method="POST">
                                        {{ csrf_field() }}
                                        <div class="mb-3">
                                            <label class="form-label" for="userpassword">Password</label>
                                            <input type="password" class="form-control" id="userpassword"
                                                name="userpassword" placeholder="Enter password" value=""
                                                required>
                                        </div>
                                        ...
                                        <div class=" mt-3 text-center">
                                            <a href="{{ route('log_out') }}" class="fw-semibold text-primary fs-11">
                                                Sign Out</a>
                                        </div>
                                    </form><!-- end form -->
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Change Lock Mode ? <a href="#!"
                                    class="fw-semibold text-primary text-decoration-underline" id="change_lock_mode">
                                    Use Mazelock </a> </p>
                        </div>
    ...
    <div id="mazlock" class="d-none">
        <div class="mhn-ui-wrap">
            ...
            {{-- <div class="mhn-ui-page page-author">
                ...
                <p class="text-center">Hi, It's me Mohan. I'm a web and graphics designer. Designing is my passion and
                    I have been working on various designing projects.</p>
                <div class="mhn-ui-bottom-link-bar">
        ...
        <div class="mt-4 text-center">
            <p class="mb-0">Change Lock Mode ? <a href="#!"
                    class="fw-semibold text-primary text-decoration-underline" id="change_default">
                    Password </a> </p>
        </div>
        {{-- <div class="mhn-ui-info">Draw 'M' shape begin from left bottom to unlock :)</div> --}}
    </div>
    ...
    <script>
        ...
        mhnUI = {
            pattern: "",
            setup: function() {
                this.lock(), this.filter(), this.colors(), this.links.setup(), this.dialog.setup(), setInterval(
                    "mhnUI.datetime()", 1e3)
            },
            lock: function() {
                mhnUI.page.hide(), pattern = new PatternLock(".mhn-lock", {
                    margin: 15
                }), $(".mhn-lock-title").html($(".mhn-lock-title").data("title")), pattern.checkForPattern(
                    "7415369",
                    function() {
                        $(".mhn-lock-title").html(
                        ...
                        }, 1e3), location.href = "{{ route('admin_dashboard') }}"
                    },
                    function() {
                        $(".mhn-lock-title").html(
                            '<span class="mhn-lock-failure">Opps! pattern is not correct</span>'), $(
                            ".patt-holder").removeClass("patt-success"), setTimeout(function() {
                            pattern.reset(), mhnUI.message()
                        }, 2e3)
                    })
            },
            message: function() {
                $(".mhn-lock-title span").fadeOut(), setTimeout(function() {
                    $(".mhn-lock-title").html($(".mhn-lock-title").data("title")), $(".mhn-lock-title span")
                        .fadeIn()
                }, 500)
            },
            datetime: function() {
                var t = new Array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"),
                    e = new Array("January", "February", "March", "April", "May", "June", "July", "August",
                ...
                var h = n.getHours(),
                    ...
                    u = n.getSeconds(),
                    l = "AM";
                h >= 12 && (l = "PM"), h > 12 && (h -= 12), 0 == h && (h = 12), 9 >= c && (c = "0" + c), 9 >= u && (
                    u = "0" + u), $(".mhn-ui-date-time .mhn-ui-day").text(t[a]), $(
                    ".mhn-ui-date-time .mhn-ui-date").text(e[o] + " " + s + ", " + i), $(
                    ".mhn-ui-date-time .mhn-ui-time").text(h + ":" + c + " " + l), $(".mhn-ui-app-time").text(
                    h + ":" + c + ":" + u + " " + l)
            },
            page: {
                show: function(t) {
            ...
            filter: function() {
                $(".mhn-ui-filter .mhn-ui-btn").click(function() {
                    ...
                    $(".mhn-ui-filter-list").toggle(100), $(".mhn-ui-filter .mhn-ui-btn").removeClass(
                        "active"), $(".mhn-ui-page-title").text($(this).text())
                })
            },
            colors: function() {
            ...
            dialog: {
                ...
                show: function(t) {
                    $('.mhn-ui-dialog-wrap a[data-action="confirm"]').attr("href", t), $(".mhn-ui-dialog-wrap")
                        .show()
                },
                hide: function() {
                    $('.mhn-ui-dialog-wrap a[data-action="confirm"]').removeAttr("href"), $(".mhn-ui-dialog-wrap")
                        .fadeOut(400)
                }
            }
        };
        ...
        ! function(t, e, n, a) {
            ...
            function s(e, n) {
                var a = this,
                    ...
                    u = h.holder = t(e);
                if (0 != u.length) {
                    h.object = a, n = h.option = t.extend({}, s.defaults, n), r(h), u.addClass("patt-holder"), "static" == u
                        .css("position") && u.css("position", "relative"), u.on("touchstart mousedown", function(t) {
                            d.call(this, t, a)
            ...
            var l = function() {},
                        ...
                        if (-1 == l.indexOf(c)) {
                            ...
                            if (o.lastPosObj) {
                                for (var g = o.lastPosObj, x = g.i, w = g.j, b = Math.abs(h.i - x), j = Math.abs(h.j - w);
                                    ...
                                    x = b ? Math.min(h.i, x) + 1 : x, w = j ? Math.min(h.j, w) + 1 : w, b = Math.abs(h.i -
                                        x), j = Math.abs(h.j - w);
                                    var M = (w - 1) * o.option.matrix[1] + x,
                                        y = o.mapperFunc(M) || M; - 1 == l.indexOf(y) && (t(s[M - 1]).addClass("hovered"), l
                                        .push(y))
                                }
                                v = [], h.j - g.j > 0 ? v.push("s") : h.j - g.j < 0 ? v.push("n") : 0, h.i - g.i > 0 ? v
                                    .push("e") : h.i - g.i < 0 ? v.push("w") : 0, v = v.join("-")
                            }
                ...
                u = function(t, e) {
                    ...
                    var n = p[e.token],
                        a = n.patternAry.join("");
                    n.holder.off(".pattern-move").removeClass("patt-hidden"), a && (n.option.onDraw(a), n.line.remove(), n
                        .rightPattern && (a == n.rightPattern ? n.onSuccess() : (n.onError(), e.error())))
                };
            o.prototype = {
                constructor: o,
                ...
                option: function(t, e) {
                    var n = p[this.token],
                        i = n.option;
                    return e === a ? i[t] : (i[t] = e, void(("margin" == t || "matrix" == t || "radius" == t) && r(
                        n)))
                },
                getPattern: function() {
                ...
                reset: function() {
                    var t = p[this.token];
                    t.pattCircle.removeClass("hovered dir s n w e s-w s-e n-w n-e"), t.holder.find(".patt-lines")
                        .remove(), t.patternAry = [], t.lastPosObj = null, t.holder.removeClass(
                            "patt-error patt-success")
                },
                error: function() {
    ...
    <script>
        $('#change_lock_mode').click(function(e) {
            e.preventDefault();
            $('#mazlock').removeClass("d-none");
            $('#password').addClass("d-none");
        });
        $('#change_default').click(function(e) {
            e.preventDefault();
            $('#mazlock').addClass("d-none");
...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-lockscreen-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Jun 2022 12:04:21 GMT -->
