...
<head>
    ...
    <title>Talent In Cloud - Too Many Request</title>
    <style>
        ...
        * {
        ...
        body {
            background: linear-gradient(to right, #f7f7f7 50%, #383838 50%);
...
<body>
    <div>
        <aside><img style="" src="{{asset('assets/images/bot.png')}}" alt="404 Image" />
        </aside>
        <main>
            <h1>Sorry!</h1>
            <p>
                We are one step ahead of you &#128512; , so you aren't cool enough to fool us  <em>.</em>
            </p>
